...
export default {
    ...
    mounted() {
        axios.get('http://sub-groyce.pythonanywhere.com/api/subscriptions/' + this.$route.params.id)
            .then( response => {
    ...
    methods: {
        update: function (e) {
            this.$validator.validate().then(result => {
                ...
                axios
                    .put(`http://sub-groyce.pythonanywhere.com/api/subscriptions/${this.subscription.id}/`,
                        this.subscription
                    )
                    .then(response => {
                        this.$router.push('/');
